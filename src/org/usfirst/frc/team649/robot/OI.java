...
public class OI {
	...
	public class Driver {
		...
		public Button manualOverrideButton1 = new JoystickButton(driveJoystickHorizontal, 11);
		public Button manualOverrideButton2 = new JoystickButton(driveJoystickVertical, 6);
		
		public double getDriveRotation() {
			final double turnVal = joystickDeadzone(driveJoystickHorizontal.getX(), MIN_DRIVE_POWER);
